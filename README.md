...
<!-- BEGIN AUTO:summary -->
**47 providers** · **118,903 IPv4 entries** · **271,650 IPv6 entries** · refreshed every 4 hours via GitHub Actions
<!-- END AUTO:summary -->
...
| Brevi Labs (Obsidian Copilot) | [txt](https://raw.githubusercontent.com/mrkhachaturov/ipranges/main/brevilabs/ipv4.txt) | [txt](https://raw.githubusercontent.com/mrkhachaturov/ipranges/main/brevilabs/ipv4_merged.txt) | — | — | brevilabs.com (api, models) and miyo.md (relay). Sites are Vercel-hosted and the endpoints sit behind Railway — ranges are shared platform edge, not Brevi Labs-owned, and the Vercel answers rotate per resolver so the list shifts between runs. |
