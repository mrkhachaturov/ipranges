...
<!-- BEGIN AUTO:summary -->
**47 providers** · **118,877 IPv4 entries** · **271,607 IPv6 entries** · refreshed every 4 hours via GitHub Actions
<!-- END AUTO:summary -->
...
| Brevi Labs (Obsidian Copilot) | [txt](https://raw.githubusercontent.com/mrkhachaturov/ipranges/main/brevilabs/ipv4.txt) | [txt](https://raw.githubusercontent.com/mrkhachaturov/ipranges/main/brevilabs/ipv4_merged.txt) | — | — | Site plus the api and models endpoints. Site is Vercel-hosted and the endpoints sit behind Railway — ranges are shared platform edge, not Brevi Labs-owned. |
